...
const params=new URLSearchParams(location.search),freezeImpact=params.get('freeze')==='impact',art=params.get('art')||'legacy';
...
async function prepareArt(){
  ...
  fighterVisualProvider=new ModelFighterProvider({assets:TRUSTED_COMBAT_FIGHTERS,strict:true,renderWidth:500,renderHeight:660});
