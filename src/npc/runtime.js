...
export function createNpcState(npc,hour=8){const slot=routineAt(npc,hour);return{id:npc.id,alive:true,health:100,locationId:npc.homeLocationId,sceneId:slot.sceneId,activity:slot.activity,currentGoal:npc.publicGoals[0]||null,flags:{}};}
