export const WUYUE_MERGER={
  ...
  phases:[
    ...
    {id:'pressure',name:'威逼合流',rumor:'五岳各派开始感受到嵩山压力，并派之议逐渐摆到台面上。',transitions:[{to:'huashan_rises',priority:110,when:{npcDead:['npc_zuo_lengchan'],flagsAll:['huashan_prepared']}},{to:'collapsed',priority:100,when:{npcDead:['npc_zuo_lengchan']}},{to:'exposed',priority:90,when:{flagsAll:['songshan_scheme_exposed']}},{to:'conference',priority:10,when:{minDay:11}}]},
