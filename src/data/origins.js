...
O('escort_heir','镖局少主','富裕',{physique:4,agility:3,charm:3},'有江湖人脉、兵器与基础武功。',G(300,[Q('weapon_long_saber'),Q('mount_horse')],['martial_basic_internal'],['asset_escort_network'])),
O('dojo_heir','武馆少主','富裕',{root:4,physique:4},'开局已经正式习武。',G(250,[],['martial_basic_internal','martial_basic_weapon_pair'],['asset_martial_school'])),
...
O('martial_clan_heir','武林世家嫡子','武林',{root:6,insight:5,charm:4},'家传武学、庄园、人脉和护卫齐备。',G(500,[Q('weapon_quality')],['martial_family_internal'],['asset_family_manor','asset_clan_guards'])),
...
O('military_house','将门之后','权贵',{physique:8,root:4,will:4},'可走江湖、军旅、朝廷三线。',G(500,[Q('mount_warhorse'),Q('armor_field')],['skill_saber_spear_basics'],['asset_military_network'])),
