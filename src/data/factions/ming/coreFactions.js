...
F('faction_east_depot','东厂','court-intelligence','ming_capital'),
F('faction_huashan','华山派','sect','ming_huashan'),
F('faction_songshan','嵩山派','sect','ming_songshan'),
F('faction_shaolin','少林','sect','ming_songshan'),
F('faction_sunmoon','日月神教','sect-power','ming_heimuya'),
F('faction_meizhuang','梅庄','hidden-manor','ming_meizhuang'),
